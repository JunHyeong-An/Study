...
public class UserServiceTest {
	...
	public void setUp() {
		// change
		user1 = new User("hello", "1234", "홍길동", 1, UserService.MIN_LOGCOUNT_FOR_SILVER, 0);
		user1.setEmail("hello@naver.com");
		// not change
		user2 = new User("guymee", "1234", "김길동");
		user2.setEmail("guymee@gmail.com");
		// change
		user3 = new User("leesw12", "1234", "고길동", 2, UserService.MIN_LOGCOUNT_FOR_SILVER+5 , UserService.MIN_RECCOMNED_FOR_GOLD + 20);
		user3.setEmail("leesw12@gmail.com");
		// change
		user4 = new User("bumjin", "1234", "이길동", 2, UserService.MIN_LOGCOUNT_FOR_SILVER+50, UserService.MIN_RECCOMNED_FOR_GOLD + 10);
