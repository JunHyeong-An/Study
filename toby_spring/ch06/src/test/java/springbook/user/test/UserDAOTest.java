...
public class UserDAOTest {
	...
	public void setUp() {
		...
		user2 = new User("guymee", "1234", "김길동", "user1@gmail.com");
		user3 = new User("leesw12", "1234", "고길동", "user1@gmail.com", 2, 55, 10);
		user4 = new User("bumjin", "1234", "이길동", "user1@gmail.com", 3, 100, 40);
	...
	public void update() {
		...
		user1.setLevel(2);
		user1.setLogin(30);
		user1.setRecommand(15);
		userDAO.update(user1);
		
		checkSameUser(userDAO.get("zello"), user1);
	}
}
