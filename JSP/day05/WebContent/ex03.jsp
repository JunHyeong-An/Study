...
<body>
	...
	<h2>EL Tag : ${map.apple}, ${map.orange }, ${map.banana }, ${map.key }</h2>
	<h2>EL Tag : ${map['apple']}</h2>
	<hr>
	<h2>map의 key는 array(or list)의 index와 같은 역할이다. 둘 다 value에 접근하기 위한 데이터이다.</h2>
